...
export function LampDemo() {
  return (
    <LampContainer>
      <motion.h1
        initial={{ opacity: 0.5, y: 30 }} // Reduced initial y to move it closer
        ...
        className="mt-4 bg-gradient-to-br from-slate-300 to-slate-500 py-2 bg-clip-text text-center text-2xl font-medium tracking-tight text-transparent md:text-4xl" // Reduced text size
      >
    ...
    >
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-40 w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <div className="absolute top-1/2 h-40 w-full translate-y-4 scale-x-150 bg-slate-950 blur-2xl"></div>
      ...
      <div className="relative z-50 flex -translate-y-12 flex-col items-center px-5"> {/* Adjusted translate-y for children */}
        {children}
      </div>
    </div>
  );
