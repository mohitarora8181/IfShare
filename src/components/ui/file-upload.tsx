                ...
                <div className="flex flex-col sm:flex-row items-center justify-center w-full min-h-[40vh]">
                    ...
                    {qrCode && <div className="p-5 bg-black z-[1000]">
                        ...
                        <span className="flex gap-2">
                            <motion.button
                                className=" px-3 bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block"
